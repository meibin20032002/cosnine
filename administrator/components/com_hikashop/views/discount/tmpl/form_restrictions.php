...
?><div class="hkc-lg-6 hikashop_tile_block hikashop_discount_edit_attributes"><div>
	...
	<dl class="hika_options large">
		...
		?></label></dt>
		<dd data-discount-display="coupon" class="input_large">
...
<div class="hkc-lg-6 hikashop_tile_block hikashop_discount_edit_attributes"><div>
	...
	<dl class="hika_options large">
		...
		<dd data-discount-display="coupon"><?php
			...
			echo JHTML::_('hikaselect.genericlist', $values, 'data[discount][discount_coupon_nodoubling]', '', 'value', 'text', @$this->element->discount_coupon_nodoubling);
		?></dd>
