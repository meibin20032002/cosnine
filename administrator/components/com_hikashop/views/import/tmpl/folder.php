...
?><table class="admintable table" cellspacing="1">
	<tr>
		...
		<td>
			<?php echo JHTML::_('hikaselect.radiolist',   $this->importFolders, 'importfolderfrom', 'class="inputbox" size="1" onclick="updateImportFolder(this.value);"', 'value', 'text','images'); ?>
		</td>
	</tr>
	<tr>
		<td class="key" >
