...
?>		<tr>
		...
		<tr>
			<td class="key">
				<label for="data[payment][payment_params][rounding]"><?php
					echo JText::_('POINTS_ROUDING');
				?></label>
			</td>
			<td>
				<input style="width: 50px;" type="text" name="data[payment][payment_params][rounding]" value="<?php echo @$this->element->payment_params->rounding; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
