...
?>
<?php echo $this->displayBlock('buttons', 0, array());?>
</div><!--end login-->
<div class="col-md-5">
...
?>
                 <?php echo $product->cart_product_quantity; ?> x <?php echo $this->getDisplayProductPrice($product, true);?>
			</td>
<?php
	if(hikashop_level(1) && !empty($this->extraFields['product'])) {
...
?>
		...
		<tr>
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_total2_title" class="hikashop_cart_subtotal_title hikashop_cart_title"><?php
...
?>
		<tr>
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_coupon_title" class="hikashop_cart_coupon_title hikashop_cart_title"><?php
...
?>
		<tr>
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_shipping_title" class="hikashop_cart_shipping_title hikashop_cart_title"><?php
...
?>
		<tr id="hikashop_checkout_cart_additional_<?php echo str_replace(' ','_',$k); ?>_line" >
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_additional_<?php echo str_replace(' ','_',$k); ?>_title" class="hikashop_cart_additional_title hikashop_cart_title"><?php
...
?>
		<tr>
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_tax_title" class="hikashop_cart_tax_title hikashop_cart_title"><?php
...
?>
		<tr>
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_payment_title" class="hikashop_cart_payment_title hikashop_cart_title"><?php
...
?>
		<tr>
			<td colspan="<?php echo $row_count - 1; ?>" id="hikashop_checkout_cart_final_total_title" class="hikashop_cart_total_title hikashop_cart_title"><?php
