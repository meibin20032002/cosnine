...
?>
		<a href="<?php echo $continue_shopping; ?>" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikabtn_checkout_continue" id="hikashop_checkout_shopping_button"><i class="fa fa-angle-left" aria-hidden="true"></i> &nbsp;<?php echo JText::_('CONTINUE_SHOPPING'); ?></a>
<?php
	}
?>
	</div>
