...
<div class="cartmain">
<h1 class="cartTitle"><?php echo $this->title?></h1>
...
<?php
	$cols = 3 + ($this->checkbox_column ? 1 : 0) + (hikashop_level(2) ? count($this->productFields) : 0);
?>
	<tfoot>
		<tr>
...
<?php
	...
	$width = (int)$this->config->get('cart_thumbnail_x', 123);
	$height = (int)$this->config->get('cart_thumbnail_y', 160);
	$image_options = array(
		'default' => true,
