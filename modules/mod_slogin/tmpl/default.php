...
<div id="slogin-buttons" class="slogin-buttons slogin-default">
    ...
    <?php
        foreach($plugins as $link):
            ...
            ?>
            <a  rel="nofollow" class="link<?php echo $link['class'];?>" <?php echo $linkParams.$title;?> href="<?php echo JRoute::_($link['link']);?>"><span class="<?php echo $link['class'];?> slogin-ico">&nbsp;</span><span class="text-socbtn">Login with <?php echo $link['plugin_title'];?></span></a>
        <?php endforeach; ?>
    <?php endif; ?>
