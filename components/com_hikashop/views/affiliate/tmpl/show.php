...
if(!empty($this->user->user_id)){
	...
	echo $this->toolbarHelper->process($this->toolbar, JText::_('AFFILIATE'));
 } ?>
					...
					<?php if($this->advanced_stats){ ?>
							<span id="affiliate_all_clicks">
								...
								echo $this->popup->display(
										JText::_('CLICKS_ALL').'<img src="'. HIKASHOP_IMAGES.'go.png" alt="'.JText::_('CLICKS_ALL').'"/>',
										'CLICKS_ALL',
						...
						<tr id="affiliate_unpaid_clicks">
							<td class="key">
								...
								if($this->advanced_stats){
									echo $this->popup->display(
										'<img src="'. HIKASHOP_IMAGES.'go.png"/>',
										'CLICKS',
